      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex justify-between items-center h-15">
          ...
          <div className="hidden md:flex items-center ml-auto space-x-10">
            ...
            <a href="#contact" className="bg-[#05091e] py-2 px-4 rounded-full border border-white text-gray-300 hover:text-white transition-all duration-300"><ShinyText text="Contact" disabled={false} speed={3} className='custom-class' /></a>
