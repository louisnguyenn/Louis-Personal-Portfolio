        ...
        <div className="max-w-5xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            ...
            >
              ...
              <a href="#contact" className="bg-[#05091e] py-2 px-4 rounded-full border border-white/80 text-gray-300 hover:text-white hover:border-[#AA8F76] transition-all duration-300">
