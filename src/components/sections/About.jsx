      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-20 items-center lg:items-start">
          ...
          <div className="flex gap-6">
            <div className="bg-[#05091e] relative rounded-xl p-6 sm:p-8 border border-white/10 hover:border-[#AA8F76] transition-all duration-300 order-2 lg:order-none hover:shadow-2xl hover:shadow-[#AA8F76]/20">
            ...
            <div className="bg-[#05091e] relative rounded-xl p-6 sm:p-8 border border-white/10 hover:border-[#AA8F76] transition-all duration-300 order-2 lg:order-none hover:shadow-2xl hover:shadow-[#AA8F76]/20">
              <ScrollReveal direction="left" distance={50} duration={0.8}>
                <h3 className="text-2xl font-bold text-gray-300 mb-4 leading-relaxed">
                  My Skills
                </h3>
